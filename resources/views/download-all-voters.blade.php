        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Voter Name</th>
                    <th style="width: 20% !important">Barangay Name</th>
                    <th style="width: 15% !important">Purok</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($voters as $index => $voter)
                    <tr>
                        ...
                        <td>{{ optional($voter->barangay)->barangay_name }}</td>
                        <td>{{ optional($voter->barangay)->purok_name }}</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
